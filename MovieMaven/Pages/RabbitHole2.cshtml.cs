...
{
    public class RabbitHole2Model : PageModel
    {
        ...
        public void OnPostRabbitHole2(string starringInMovieID) //third step steps back to 2 cycles
        {
            Response.Redirect("./RabbitHole?movieID=" + starringInMovieID);
